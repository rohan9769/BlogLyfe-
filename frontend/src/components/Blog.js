...
const Blog = () => {
    ...
    useEffect(()=>{
        axios.get(`http://127.0.0.1:8000/api/blog/featured`)
        .then((response)=>{
            ...
            <div className="container mt-3">
                ...
                <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
                    <div class="col-md-6 px-0">
                        ...
                        <p class="lead mb-0"><Link to={`/blog/${featuredBlog.slug}`} class="text-white font-weight-bold">Continue reading...</Link></p>
                    </div>
                </div>
                {getBlogs()}
            </div>
